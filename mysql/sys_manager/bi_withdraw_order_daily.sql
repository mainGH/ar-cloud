...
-- ----------------------------
-- Table structure for bi_withdraw_order_daily
-- ----------------------------
DROP TABLE IF EXISTS `bi_withdraw_order_daily`;
CREATE TABLE `bi_withdraw_order_daily`  (
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '代付订单月报' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of bi_withdraw_order_daily
-- ----------------------------
INSERT INTO `bi_withdraw_order_daily` VALUES (6, '2023-11-19', NULL, 100.00, 100.00, 1, 1, 0.00, '2023-11-21 21:48:59', '2023-11-21 21:48:59', '2023-11-21 21:49', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `bi_withdraw_order_daily` VALUES (7, '2023-11-20', NULL, 100.00, 100.00, 1, 1, 0.00, '2023-11-21 21:49:00', '2023-11-21 21:49:00', '2023-11-21 21:49', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `bi_withdraw_order_daily` VALUES (8, '2023-11-21', NULL, 100.00, 100.00, 1, 1, 0.00, '2023-11-21 21:49:00', '2023-11-21 21:49:00', '2023-11-21 21:49', NULL, NULL, NULL, NULL, NULL, NULL);
