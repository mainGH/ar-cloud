...
public class ArGenerator{
    ...
    // 数据库 URL
    private static final String URL = "jdbc:mysql://8.222.160.178:3306/ar_wallet?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
    // 数据库驱动
    ...
    // 包的基础路径
    private static final String BASE_PACKAGE_URL = "org.ar.wallet";
    // xml文件路径
    ...
    public static void main(String[] args) {
        ...
        globalConfig.setOutputDir(projectPath + "/ar-wallet/src/main/java");
