...
public class WebLogAspect {
     ...
     * 最后的两个点：所有类型的参数
     */
    @Pointcut("execution(public * org.ar.powjob.web.controller..*.*(..))")
    public void include() {
    }

    @Pointcut("execution(public * org.ar.powjob.web.controller.ServerController.*(..))")
    public void exclude() {
    }
